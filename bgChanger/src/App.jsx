...
function App() {
 const [color, setcolor] = useState("olive")
  ...
  return (
    ...
    <button onClick={() => setcolor("skyblue")} className="outline-none px-4 py-1 rounded-full text-white shadow-lg" style={{backgroundColor : "skyblue", color:"black"}}>White</button>
